# this file was slightly modified from the original tevatron code to add RNN-related parameters.
...
class ModelArguments:
    ...
    rnn_query: bool = field(default=False)
    rnn_pretrained_path: str = field(default=None)
    freeze_passage_enc: bool = field(default=False)
...
class TevatronTrainingArguments(TrainingArguments):
    ...
    query_lr: float = field(default=None)  # use a different learning rate for the query encoder.
